...
int sepp_initialize()
{
    ...
    rv = ogs_sbi_context_parse_config("sepp", "nrf");
...
void sepp_terminate(void)
{
    ...
    sepp_event_final(); /* Destroy event */
}
...
static void sepp_main(void *data)
{
    ...
    ogs_fsm_create(&sepp_sm, sepp_state_initial, sepp_state_final);
    ogs_fsm_init(&sepp_sm, 0);
