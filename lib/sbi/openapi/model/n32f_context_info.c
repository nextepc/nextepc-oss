...
{
    OpenAPI_n32f_context_info_t *n32f_context_info_local_var = OpenAPI_malloc(sizeof(OpenAPI_n32f_context_info_t));
    if (!n32f_context_info_local_var) {
        return NULL;
    }
...
OpenAPI_n32f_context_info_t *OpenAPI_n32f_context_info_parseFromJSON(cJSON *n32f_context_infoJSON)
{
    ...
    cJSON *n32f_context_id = cJSON_GetObjectItemCaseSensitive(n32f_context_infoJSON, "n32fContextId");
    if (!n32f_context_id) {
