...
{
    OpenAPI_callback_name_t *callback_name_local_var = OpenAPI_malloc(sizeof(OpenAPI_callback_name_t));
    if (!callback_name_local_var) {
        return NULL;
    }
...
OpenAPI_callback_name_t *OpenAPI_callback_name_parseFromJSON(cJSON *callback_nameJSON)
{
    ...
    cJSON *callback_type = cJSON_GetObjectItemCaseSensitive(callback_nameJSON, "callbackType");
    if (!callback_type) {
